export default function Achievers() {
  return (
    <section id="achievers" className="py-16 md:py-24 px-6 relative overflow-hidden bg-dark-bg">
      {/* Background glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-brand-gold/5 blur-[200px] rounded-full pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 md:gap-16 items-start mt-12 md:mt-20">
            ...
            <table className="w-full text-left">
              <thead>
                <tr className="border-b border-white/10">
                  <th className="p-4 text-xs font-bold text-white/40 uppercase tracking-widest"></th>
                  <th className="p-4 text-center text-sm font-black text-brand-gold">2019</th>
                  <th className="p-4 text-center text-sm font-black text-brand-gold">2020</th>
                  <th className="p-4 text-center text-sm font-black text-brand-gold">2021</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-white/5">
                  <td className="p-4 text-sm font-bold text-white">Students Enrolled</td>
                  <td className="p-4 text-center text-2xl font-black text-white">7</td>
                  <td className="p-4 text-center text-2xl font-black text-white">14</td>
                  <td className="p-4 text-center text-2xl font-black text-brand-orange">18</td>
                </tr>
                <tr>
                  <td className="p-4 text-sm font-bold text-white">Govt. MBBS Seats</td>
                  <td className="p-4 text-center text-2xl font-black text-white">4</td>
                  <td className="p-4 text-center text-2xl font-black text-white">10</td>
                  <td className="p-4 text-center text-2xl font-black text-brand-orange">15</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div className="relative sticky top-32 space-y-8">
          ...
          {/* Floating Accents */}
          <div className="absolute -left-4 top-1/4 w-6 h-6 bg-brand-gold rotate-45 animate-float" />
