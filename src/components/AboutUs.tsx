      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-10 md:gap-16 items-center">
        ...
        <div className="relative order-2 lg:order-1">
          ...
          <div className="relative glass-card aspect-square rounded-3xl overflow-hidden border-white/10 shadow-2xl">
            ...
            {/* Floating Quote */}
            <div className="absolute bottom-4 left-4 right-4 md:bottom-8 md:left-8 md:right-8 p-4 md:p-6 glass-card bg-black/40 backdrop-blur-md rounded-2xl border-white/10">
              <p className="text-white font-serif italic text-base md:text-lg leading-relaxed">
