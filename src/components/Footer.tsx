  ...
  return (
    <footer className="relative bg-black overflow-hidden">
      ...
      <div className="relative border-b border-white/5">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 md:py-16 flex flex-col md:flex-row items-center justify-between gap-8 relative z-10">
          ...
          <a
            ...
            className="group relative px-8 md:px-10 py-4 bg-gradient-to-r from-brand-orange to-brand-gold rounded-full text-sm font-black text-white uppercase tracking-wider overflow-hidden transition-transform duration-300 hover:scale-105 shadow-lg shadow-brand-orange/20 hover:shadow-brand-orange/40"
          >
