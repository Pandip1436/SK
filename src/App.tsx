...
function App() {
  return (
    <div className="bg-dark-bg min-h-screen selection:bg-brand-gold selection:text-black">
      ...
      <a
        href="https://wa.me/919095636001?text=Hi%20THE%20SK%20LEARNINGS,%20I'm%20interested%20in%20NEET%20coaching!"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-8 right-8 z-[60] w-16 h-16 bg-[#25D366] rounded-full flex items-center justify-center shadow-2xl hover:scale-110 active:scale-95 transition-all duration-300 group"
      >
